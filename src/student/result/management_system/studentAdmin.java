...
public class studentAdmin extends javax.swing.JFrame {
 ...
 //         ResultSet rs = st.executeQuery("select * from student inner join result on student.rollno = result.rollno where student.rollno='"+rollno+"'");
        if(rs.next()){
            ...
            if(Integer.parseInt(jTextField6.getText()) < 33) {
        jTextField6.setForeground(Color.RED);
}
            if(Integer.parseInt(jTextField7.getText()) < 33) {
        jTextField7.setForeground(Color.RED);
}
            if(Integer.parseInt(jTextField8.getText()) < 33) {
        jTextField8.setForeground(Color.RED);
}
            if(Integer.parseInt(jTextField9.getText()) < 33) {
        jTextField9.setForeground(Color.RED);
}
            if(Integer.parseInt(jTextField10.getText()) < 33) {
        jTextField10.setForeground(Color.RED);
}
           int marks = Integer.parseInt(jTextField11.getText());
        
        if(marks >= 375){
        jTextField12.setForeground(Color.GREEN);
        jTextField12.setText("First Division with Distinction");
    }else if(marks >= 300){
        jTextField12.setForeground(Color.GREEN);
        jTextField12.setText("First Division");
    }else if(marks >= 165){
        jTextField12.setForeground(Color.GREEN);
        jTextField12.setText("Second Division");
    }else if(marks < 165){
